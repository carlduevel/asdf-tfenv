...
install_version() {
  ...
  (
    ...
    echo $tool_cmd
    echo """ test -f "$install_path/$tool_cmd" || fail "Expected $install_path/bin/$tool_cmd to be a file." """
    echo """ test -x "$install_path/$tool_cmd" || fail "Expected $install_path/bin/$tool_cmd to be executable." """
